...
class InceptE(BaseE):
    ...
    def __init__(self, args):
        ...
        self.branch1_e1 = torch.nn.Sequential(
            torch.nn.Conv2d(1, 128, kernel_size=1, stride=1, bias=True),
        ...
        self.e1_fuse_1x1conv = torch.nn.Conv2d(128, 128, kernel_size=1)
        self.r_fuse_1x1conv = torch.nn.Conv2d(128, 128, kernel_size=1)
        self.e1_distribute_1x1conv = torch.nn.Conv2d(128,128, kernel_size=1)
        self.r_distribute_1x1conv = torch.nn.Conv2d(128, 128, kernel_size=1)

        self.fc_e1 = torch.nn.Linear(25600, 200)
        self.fc_r = torch.nn.Linear(25600, 200)
...
class ChannelAttention(torch.nn.Module):
    def __init__(self, in_planes):
        ...
        self.fc = torch.nn.Sequential(torch.nn.Conv2d(in_planes, in_planes // 32, 1, bias=False),
                               torch.nn.ReLU(),
                               torch.nn.Conv2d(in_planes // 32, in_planes, 1, bias=False))
