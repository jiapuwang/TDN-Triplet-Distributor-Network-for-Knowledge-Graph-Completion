...
parser.add_argument(
    "--max_epochs", default=800, type=int, help="Maximum number of epochs to train for"
)
parser.add_argument(
    "--patience", default=100, type=int, help="Number of epochs before early stopping"
)
parser.add_argument(
...
parser.add_argument(
    "--dtype", default="float", type=str, choices=["single", "double", "float"], help="Machine precision"
)
parser.add_argument(
